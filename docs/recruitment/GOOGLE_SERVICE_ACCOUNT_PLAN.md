...
## 4) API endpoints now implemented (`api/recruitment.js`)

The following resources are available in `api/recruitment.js`:
...
## 7) If Vercel API function count is a concern
